...
public class C01_WindowHandleSe4 extends BaseTest {
    ...
    public  void newWindow(){
      ...
      driver.switchTo().newWindow(WindowType.WINDOW);//yeni pencere oluşturup switvh ediyoruz...
...
@Test
    ...
    WebDriver newTab=driver.switchTo().newWindow(WindowType.TAB);//yeni sekme oluşturuldu .
...
@Test
    public void handleWindows(){
        ...
        driver.get("https://www.amazon.com/");//ana sekme açılıyor
